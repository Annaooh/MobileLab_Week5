...
//  GameInterface
//
//  Created by Anna Oh on 6/3/2019.
...
class ViewController: UIViewController, WebSocketDelegate, UITextFieldDelegate {
    ...
    @IBOutlet weak var pressedUp: UIButton!
    ...
    @IBAction func didTapUp(_ sender: UIButton) {
       sendDirectionMessage(.up)
        //pressed image setup
//       didTapUp.button = UIButton (named: "pressedUp")
    }
...
//        upButton.setImage; : [UIImage ImageNamed:@"up2.png"] forState: UIControlStateNormal;
//        
//         setImage:[UIImage ImageNamed:@"pressedUp.png"] forState: UIControlStateHighlighted ;
        
        super.viewDidLoad()

        ///////////transform //////////
//        upButton.transform =  upButton.transform.rotated(by: CGFloat.pi / 4.0)
//
//        rightButton.transform =  rightButton.transform.rotated(by: CGFloat.pi / 4.0)
//
//         downButton.transform =  downButton.transform.rotated(by: CGFloat.pi / 4.0)
//
//         leftButton.transform =  leftButton.transform.rotated(by: CGFloat.pi / 4.0)
//
